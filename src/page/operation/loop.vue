    ...
    methods: {
      ...
      uploadSuccess(response) {
        if (response.code === api.success_code) {
          //上传成功.
          //回显图片
          //http://localhost:8085/portal/image/1595601323571_736350850812739584.png
          this.loop.imageUrl = constants.imageBaseUrl + response.data.id;
