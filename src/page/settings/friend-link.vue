    ...
    <div class="friend-link-list-box">
      <el-table
        ...
        <el-table-column
                ...
                width="200">
          <template slot-scope="scope">
            <el-image fit="cover" :src="imgBaseUrl+scope.row.logo"
          ...
          <el-form label-width="110px" size="medium">
            ...
            <el-form-item label="logo">
              <div class="friend-link-image-upload" @click="showLinkLogoDialog">
                ...
                <el-image v-else :src="imgBaseUrl+link.logo"></el-image>
              </div>
            </el-form-item>
          </el-form>
        </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        targetDeleteLinkId: '',
        imgBaseUrl: constants.imageBaseUrl
      }
    },
    methods: {
      doDeleteItem() {
